  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav" >
        ...
        <li class="active"><a href="main-adm.php">Student<span class="sr-only">(current)</span></a></li>
	...
	<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for email.." align="right">
                   ...
                   <a href="delete.php"><button class="btn">Delete</button></a>
                    <table id="myTable">
                      <tr class="header">
                        ...
                        <th style="width:5%;">Phone Number(H)</th>
                        <th style="width:5%;">Mobile Number(HP)</th>
                      </tr>
                      <tr>
                      	<?php
                     ...
                     Print '<tr>
                        ...
                        <td>'.$row['Stu_IC'].'</td>
                        <td>'.$row['Stu_Sex'].'</td>
                        <td>'.$row['Stu_SchoolName'].'</td>
                        <td>'.$row['Stu_Address'].'</td>
                        <td>'.$row['Stu_Category'].'</td>
                        <td>'.$row['Stu_Num_H'].'</td>
                        <td>'.$row['Stu_Num_Hp'].'</td>
                     </tr>';
                   }
                ?>
                     </tr>
